...
\begin{cventries}
  \cventry
    {\makecell[l]{Master of Science (M.S.) in Nuclear Engineering \textemdash \ GPA: 3.79\\ Bachelor of Science (B.S.) in Nuclear Engineering \textemdash \ GPA: 3.71, \ Magna Cum Laude}} % Degree % Cambria broke the dash formatting; have to use \textendash or \textemdash for longer dashes instead of -- or ---
    {Oregon State University} % Institution
    {Corvallis, OR} % Location
    {\makecell[r]{Expected March 2023\\ June 2020}} % Date(s)
    {
